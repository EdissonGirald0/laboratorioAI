...
# Script para importar credenciales y workflows en n8n
# Este script debe ejecutarse después de que n8n esté completamente iniciado
...
echo -e "${YELLOW}Importando credenciales y workflows en n8n...${NC}"
...
until curl -s http://localhost:5678/healthz > /dev/null 2>&1; do
    ...
    if [ $counter -ge $timeout ]; then
        echo -e "${RED}Error: n8n no respondió después de ${timeout} segundos${NC}"
        exit 1
    fi
done
...
CRED_DIR="./n8n/credentials"
WORKFLOW_DIR="./n8n/workflows"

# Nota: n8n no tiene una API REST pública para importar credenciales directamente
# Las credenciales deben ser importadas manualmente o a través de la interfaz web

echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}📋 CREDENCIALES DISPONIBLES PARA IMPORTAR:${NC}"
echo -e ""
echo -e "Las siguientes credenciales están listas en ${CRED_DIR}:"
echo -e ""
...
echo -e ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}🔄 WORKFLOWS DISPONIBLES PARA IMPORTAR:${NC}"
echo -e ""
echo -e "Los siguientes workflows están listos en ${WORKFLOW_DIR}:"
echo -e ""
...
echo -e ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}📖 INSTRUCCIONES DE IMPORTACIÓN:${NC}"
echo -e ""
echo -e "1. Accede a n8n: http://localhost:5678"
echo -e "2. Crea tu cuenta de administrador (si es la primera vez)"
echo -e ""
echo -e "${YELLOW}Para importar CREDENCIALES:${NC}"
echo -e "   a) Ve a Settings → Credentials"
echo -e "   b) Click en 'Add Credential'"
echo -e "   c) Selecciona el tipo de credencial"
echo -e "   d) Copia los datos desde:"
echo -e "      ${CRED_DIR}/"
echo -e ""
echo -e "${YELLOW}Para importar WORKFLOWS:${NC}"
echo -e "   a) Ve a Workflows"
echo -e "   b) Click en el menú (tres puntos) → 'Import from File'"
echo -e "   c) Selecciona los archivos desde:"
echo -e "      ${WORKFLOW_DIR}/"
echo -e ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}✅ Credenciales y workflows listos para importar${NC}"
echo -e ""

# Crear un archivo de resumen
cat > ./n8n/IMPORT_INSTRUCTIONS.md << 'EOF'
...
echo -e "${GREEN}✅ Archivo de instrucciones creado: ./n8n/IMPORT_INSTRUCTIONS.md${NC}"
